...
import static io.flutter.plugins.webviewflutter.FileUploadActivity.IMAGE_EXTRA;
import static io.flutter.plugins.webviewflutter.FileUploadActivity.VIDEO_EXTRA;
...
//    private ValueCallback<Uri[]> mUploadMessageArray;
    ...
    private class FlutterWebChromeClient extends WebChromeClient {
        ...
        FlutterWebChromeClient(Context context) {
            mContext = context;
        }

        @Override
        public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams) {
//            TODO(HMM) how to stop previous unfinished callback
...
//            mUploadMessageArray = filePathCallback;
            ...
            /// prepare bundle data for requested file type
            boolean isRequestImage = acceptsImages(acceptTypes);
            boolean isRequestVideo = acceptsVideo(acceptTypes);

            Intent intent = new Intent(mContext, FileUploadActivity.class);
            FileUploadActivity.getFilePathCallback(filePathCallback, fileChooserParams);
            intent.putExtra(IMAGE_EXTRA, isRequestImage);
            intent.putExtra(VIDEO_EXTRA, isRequestVideo);
